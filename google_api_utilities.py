...
class gmailHandler :
    ...
    def send_Mail(self, message_plain_text, to, sender='me', subject=None, attachments=[], reply_message_id=None) :
        '''
        Usage - 
    ...
    def get_mail(self, message_id, user_id='me', format='metadata') : 
        return self.mail_service.users().messages().get(userId=user_id, id=message_id, format=format).execute()
